...
int main () 
{
    ...
    if( pthread_create(&tid, NULL, (void *) mifuncion, (void *) misargs) ) // DEVUELVE 0 SI CORRECTO. 0 = FALSO EN C --> NO ENTRA A IF
    {
    ...
    if( pthread_join(tid, NULL) ) // DEVUELVE 0 SI CORRECTO
    {
